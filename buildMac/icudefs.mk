...
VERSION = 54.1
UNICODE_VERSION = 7.0
SO_TARGET_VERSION = 54.1
SO_TARGET_VERSION_MAJOR = 54
...
ICUDATA_BASENAME_VERSION = $(ICUPREFIX)dt54
# the entry point is almost like the basename, but has the lib suffix.  
ICUDATA_ENTRY_POINT = $(ICUPREFIX)dt54 
ICUDATA_CHAR = l
...
CXXFLAGS = -O2  -W -Wall -pedantic -Wpointer-arith -Wwrite-strings -Wno-long-long --std=c++0x $(THREADSCXXFLAGS) -Qunused-arguments -Wno-parentheses-equality
